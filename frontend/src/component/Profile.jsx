    ...
    <div>
      ...
      <section className="  container mt-3  py-5 rounded px-5">
        <div class="d-flex mb-5 mt-4 ms-lg-5 ps-lg-5 ms-0 ps-0">
          ...
          <div className="insta-ring-wrapper me-md-5 me-3 ms-lg-5 ms-0">
            <img src={value.user.image} alt="Profile" className="profile-img" />
          </div>

          <div class=" w-50">
            <h2 class="mt-3 mb-4">{value.user.name}</h2>
            ...
            {user1.id === params.id ? (
              ...
              <button
                ...
                type="button"
                className="insta-gradient-btn btn text-white fw-bold"
              >
